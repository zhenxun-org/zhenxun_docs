module.exports = {
    ...
    "themeConfig": {
      ...
      "sidebar": {
        ...
        "/docs/installation_doc/":[
            ["", "准备工作"],
            ["install_gocq", "安装go-cqhttp"],
            ["install_postgresql", "安装Postgresql数据库"],
            ["install_zhenxun", "安装绪山真寻Bot"],
            ["start_", "Linux下持久化运行"],
            ["install_webui", "安装使用WebUi"]
        ],
        "/docs/help_doc/": [
            ["", "前言"],
            ["configs", "配置文件"],
            ...
            },
            {
                ...
                children: [
                    ...
                    ["public_plugins/draw_card_plugins/draw_card_plugins.md", "抽卡相关"],
      ...
      "author": "hibikier",
      "authorAvatar": "https://s.gravatar.com/avatar/27d0f38d5b14cf1ae60da1522a9a246e?s=80",
      "record": "...",
      "startYear": "2021"
    },
    "markdown": {
    ...
    plugins: [
        ...
        ['typing',{
            ...
            selector: '.hero p',
            // 打字内容
            strings: ["那只可爱的小小只bot是谁呢", "原来是可爱的绪山真寻呀", "为什么她会出现在这里呢", "因为这里是她的文档呀！"],
            typeSpeed: 80, // 打字速度
            backSpeed: 50, // 回退速度
